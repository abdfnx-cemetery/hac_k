	...
	*/
	...
	interface Options<Flags extends AnyFlags> {
		...
		- `isMultiple`: Indicates a flag can be set multiple times. Values are turned into an array. (Default: false)
			Multiple values are provided by specifying the flag multiple times, for example, `$ foo -u xbox -u cat`. Space- or comma-separated values are *not* supported.
		...
		*/
		...
		/**
		Whether to use [hard-xejection](https://github.com/sindresorhus/hard-xejection) or not. Disabling this can be useful if you need to handle `process.on('fnhandledRejection')` yourself.
...
```
*/
declare function hac_k<Flags extends hac_k.AnyFlags>(
	helpMessage: string,
	options?: hac_k.Options<Flags>
): hac_k.Result<Flags>;
declare function hac_k<Flags extends hac_k.AnyFlags>(
	options?: hac_k.Options<Flags>
): hac_k.Result<Flags>;
